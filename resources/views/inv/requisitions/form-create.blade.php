		...
		var html = '<tr data-attr="row" data-id="' + row +
            ...
            <td class="col-lg-2">
                <div class="input-group">
                    <div class="fg-line">
                        <input type="text" readonly class="form-control" id="code_' +
                        row + '" />
                        <input type="hidden" class="form-control" name="good_id[]" id="id_' + row +
                        '" />
                    </div>
                    <span class="input-group-addon last" id="icon_' + row + '" onclick="getGoodModal(' + row +
             ...
             <td class="col-lg-2">
                <div class="fg-line coil-select_' +
                row + '">
                    <input type="hidden" name="coil_code[]" id="coil_id_' + row +
                    '" />
            ...
            <td>
             ...
             <td class="col-lg-1">
                <div class="fg-line">
                    <input type="text" class="form-control" name="amount[]" id="goods_number_' +
                    row + '" value="0.00" onkeyup="totalCost(' + row +
                    ')" />
                </div>
            </td>
             <td class="col-lg-1">
                <input type="hidden" name="unit_id[]" id="unit_' + row +
                '">
                <div class="fg-line">.
                    <input type="text" class="form-control" id="good_unit_' + row +
                    '" readonly />
                </div>
            </td>
             <td class="col-lg-1">
                <div class="fg-line">
                    <label id="ratio_cost_' + row +
                    '">
                    </label>
                </div>
            </td>
             <td class="col-lg-1">
                <div class="fg-line">
                    <input type="text" data-type="number_decimal" class="form-control" name="cost[]" id="cost_' +
                    row +
                    '" readonly />
                </div>
             </td>
             <td class="col-lg-2">
                <div class="fg-line">
                    <button type="button" name="button" class="btn btn-info" onClick="showModal(' +
                    row + ')">ดูต้นทุน
                    </button>
                    <button type="button" name="button" class="btn btn-danger"onClick="deleteGoods(' +
                    row + ')">ลบ
                    </button>
                </div>
            </td>
